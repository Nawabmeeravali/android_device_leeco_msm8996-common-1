...
public final class Drive {
    public static final Api<NoOptions> API = new Api("Drive.API", new C04021(), zzNX, new Scope[0]);
    ...
    public static final Api<zzb> zzada = new Api("Drive.INTERNAL_API", new C04032(), zzNX, new Scope[0]);
    ...
    static class C04021 extends zza<NoOptions> {
        C04021() {
        }
    ...
    static class C04032 extends zza<zzb> {
        C04032() {
        }
