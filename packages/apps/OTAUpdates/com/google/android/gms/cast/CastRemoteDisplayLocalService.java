...
public abstract class CastRemoteDisplayLocalService extends Service {
    ...
    private static final int zzQX = C0116R.id.cast_notification_id;
    ...
    private final Callback zzRm = new C02111(this);
    private final IBinder zzRo = new zza();

    class C02111 extends Callback {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        C02111(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
    ...
    class C02143 implements CastRemoteDisplaySessionCallbacks {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        class C02131 implements Runnable {
            final /* synthetic */ C02143 zzRu;

            C02131(C02143 c02143) {
                this.zzRu = c02143;
            }
        ...
        C02143(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzRp = castRemoteDisplayLocalService;
        }
        ...
        public void onRemoteDisplayEnded(Status status) {
            ...
            if (this.zzRp.mHandler != null) {
                this.zzRp.mHandler.post(new C02131(this));
            }
        }
    }

    class C02154 implements ResultCallback<CastRemoteDisplaySessionResult> {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        C02154(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzRp = castRemoteDisplayLocalService;
        }
    ...
    class C02165 implements ResultCallback<CastRemoteDisplaySessionResult> {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        C02165(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzRp = castRemoteDisplayLocalService;
        }
    ...
    class C02176 implements ConnectionCallbacks {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        C02176(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzRp = castRemoteDisplayLocalService;
        }
    ...
    class C02187 implements OnConnectionFailedListener {
        final /* synthetic */ CastRemoteDisplayLocalService zzRp;

        C02187(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
            this.zzRp = castRemoteDisplayLocalService;
        }
    ...
    private Notification zzN(boolean z) {
        ...
        if (z) {
            i = C0116R.string.cast_notification_connected_message;
            i2 = C0116R.drawable.cast_ic_notification_on;
        } else {
            i = C0116R.string.cast_notification_connecting_message;
            i2 = C0116R.drawable.cast_ic_notification_connecting;
        }
        ...
        Notification build = new Builder(this).setContentTitle(zzb).setContentText(string).setContentIntent(this.zzRe.zzRv).setSmallIcon(i2).setOngoing(true).addAction(17301560, getString(C0116R.string.cast_notification_disconnect), zzlm()).build();
        startForeground(zzQX, build);
        return build;
    }

    private GoogleApiClient zza(CastDevice castDevice) {
        return new GoogleApiClient.Builder(this, new C02176(this), new C02187(this)).addApi(CastRemoteDisplay.API, new CastRemoteDisplayOptions.Builder(castDevice, this.zzRb).build()).build();
    }
    ...
    private void zzlh() {
        ...
        if (this.zzRa == null || !this.zzRa.isConnected()) {
            ...
            CastRemoteDisplay.CastRemoteDisplayApi.startRemoteDisplay(this.zzRa, this.zzQv).setResultCallback(new C02154(this));
        }
    }
    ...
    private void zzli() {
        ...
        if (this.zzRa == null || !this.zzRa.isConnected()) {
            ...
            CastRemoteDisplay.CastRemoteDisplayApi.stopRemoteDisplay(this.zzRa).setResultCallback(new C02165(this));
        }
    }
