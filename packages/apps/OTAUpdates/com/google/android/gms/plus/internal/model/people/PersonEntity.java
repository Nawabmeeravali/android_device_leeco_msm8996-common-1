...
public final class PersonEntity extends FastSafeParcelableJsonResponse implements Person {
    ...
    public static final class CoverEntity extends FastSafeParcelableJsonResponse implements Cover {
        ...
        public static final class CoverPhotoEntity extends FastSafeParcelableJsonResponse implements CoverPhoto {
            ...
            static {
                ...
                zzaHP.put(PlusShare.KEY_CALL_TO_ACTION_URL, Field.zzl(PlusShare.KEY_CALL_TO_ACTION_URL, 3));
    ...
    public static final class ImageEntity extends FastSafeParcelableJsonResponse implements Image {
        ...
        static {
            zzaHP.put(PlusShare.KEY_CALL_TO_ACTION_URL, Field.zzl(PlusShare.KEY_CALL_TO_ACTION_URL, 2));
        }
    ...
    public static final class OrganizationsEntity extends FastSafeParcelableJsonResponse implements Organizations {
        ...
        static {
            ...
            zzaHP.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, Field.zzl(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, 3));
            ...
            zzaHP.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_TITLE, Field.zzl(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_TITLE, 9));
    ...
    static {
        ...
        zzaHP.put(PlusShare.KEY_CALL_TO_ACTION_URL, Field.zzl(PlusShare.KEY_CALL_TO_ACTION_URL, 27));
