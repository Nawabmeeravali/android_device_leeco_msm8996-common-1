...
public class zzi extends SurfaceView implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, Callback {
    ...
    class C01222 implements Runnable {
        ...
        C01222(zzi com_google_android_gms_ads_internal_overlay_zzi) {
    ...
    class C01244 implements Runnable {
        ...
        C01244(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    class C01255 implements Runnable {
        ...
        C01255(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    class C01266 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C01266(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    class C01277 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C01277(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        this.zzzV = 5;
        this.zzzW = 5;
        zzhl.zzGk.post(new C01222(this));
    }
    ...
    public void pause() {
        ...
        if (zzeT() && this.zzzY.isPlaying()) {
            this.zzzY.pause();
            this.zzzV = 4;
            zzhl.zzGk.post(new C01277(this));
        }
        this.zzzW = 4;
    }
    ...
    public void play() {
        ...
        if (zzeT()) {
            this.zzzY.start();
            this.zzzV = 3;
            zzhl.zzGk.post(new C01266(this));
        }
        this.zzzW = 3;
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        this.zzzX = holder;
        zzeP();
        zzhl.zzGk.post(new C01244(this));
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        this.zzzX = null;
        zzhl.zzGk.post(new C01255(this));
        zzv(true);
    }
