...
public class zzp extends AbstractPendingResult<ContainerHolder> {
    ...
    class C09382 implements com.google.android.gms.tagmanager.zzo.zza {
        final /* synthetic */ zzp zzaKZ;

        C09382(zzp com_google_android_gms_tagmanager_zzp) {
    ...
    public void load(final String resourceIdParameterName) {
        this.zzaKR.zza(this.zzaKy, this.zzaKP != -1 ? Integer.valueOf(this.zzaKP) : null, resourceIdParameterName, new com.google.android.gms.internal.zzqa.zza(this) {
            ...
            class C09361 implements com.google.android.gms.tagmanager.zzo.zza {
                final /* synthetic */ C09371 zzaLa;

                C09361(C09371 c09371) {
                    this.zzaLa = c09371;
                }
            ...
            public void zza(zzqe com_google_android_gms_internal_zzqe) {
                ...
                this.zzaKZ.zzaKS = new zzo(this.zzaKZ.zzaKK, this.zzaKZ.zzWt, new Container(this.zzaKZ.mContext, this.zzaKZ.zzaKK.getDataLayer(), this.zzaKZ.zzaKy, com_google_android_gms_internal_zzqe.zzAg().zzAl(), zzAk), new C09361(this));
                this.zzaKZ.setResult(this.zzaKZ.zzaKS);
            }
        });
    }
    ...
    public void zzyr() {
        com.google.android.gms.internal.zzqf.zzc zziR = this.zzaKQ.zziR(this.zzaKP);
        if (zziR != null) {
            setResult(new zzo(this.zzaKK, this.zzWt, new Container(this.mContext, this.zzaKK.getDataLayer(), this.zzaKy, 0, zziR), new C09382(this)));
        } else {
