...
public class UsageInfo implements SafeParcelable {
    ...
    private static DocumentSection zzbt(String str) {
        return new DocumentSection(str, new com.google.android.gms.appdatasearch.RegisterSectionInfo.zza(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_TITLE).zzaj(1).zzK(true).zzbs("name").zzkM(), "text1");
    }
    ...
    private static DocumentSection zzh(Uri uri) {
        return new DocumentSection(uri.toString(), new com.google.android.gms.appdatasearch.RegisterSectionInfo.zza("web_url").zzaj(4).zzJ(true).zzbs(PlusShare.KEY_CALL_TO_ACTION_URL).zzkM());
    }
