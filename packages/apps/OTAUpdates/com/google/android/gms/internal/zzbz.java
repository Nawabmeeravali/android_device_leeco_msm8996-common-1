...
public final class zzbz {
    ...
    public static final zzbv<Integer> zztP = zzbv.zza("gads:video_stream_cache:limit_space", 8388608);
    ...
    public static final zzbv<Integer> zztS = zzbv.zza("gads:video_stream_cache:connect_timeout_millis", (int) StatusCodes.AUTH_DISABLED);
