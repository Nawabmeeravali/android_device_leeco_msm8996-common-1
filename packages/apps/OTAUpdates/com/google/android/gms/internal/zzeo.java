...
public class zzeo extends zzeu {
    ...
    class C06741 implements OnClickListener {
        ...
        C06741(zzeo com_google_android_gms_internal_zzeo) {
    ...
    class C06752 implements OnClickListener {
        ...
        C06752(zzeo com_google_android_gms_internal_zzeo) {
            this.zzyt = com_google_android_gms_internal_zzeo;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzJ.setTitle(zzo.zzby().zzc(C0116R.string.create_calendar_title, "Create calendar event"));
            zzJ.setMessage(zzo.zzby().zzc(C0116R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzJ.setPositiveButton(zzo.zzby().zzc(C0116R.string.accept, "Accept"), new C06741(this));
            zzJ.setNegativeButton(zzo.zzby().zzc(C0116R.string.decline, "Decline"), new C06752(this));
            zzJ.create().show();
        } else {
