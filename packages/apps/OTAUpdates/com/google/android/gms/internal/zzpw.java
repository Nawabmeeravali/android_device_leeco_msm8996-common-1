...
public class zzpw {
    ...
    class C08271 implements ResultCallback<ContainerHolder> {
        final /* synthetic */ zzpw zzaOY;

        C08271(zzpw com_google_android_gms_internal_zzpw) {
    ...
    public void start() throws IllegalStateException {
        synchronized (this) {
            if (this.mStarted) {
                ...
                this.mStarted = true;
                this.zzaOX.zzc(this.zzoY.zzzT(), -1, "admob").setResultCallback(new C08271(this));
            }
        }
    }
