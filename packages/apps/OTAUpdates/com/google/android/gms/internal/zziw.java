...
public class zziw implements AppInviteApi {
    ...
    final class zzb extends zza<Status> {
        ...
        class C07331 extends com.google.android.gms.internal.zziy.zza {
            final /* synthetic */ zzb zzOb;

            C07331(zzb com_google_android_gms_internal_zziw_zzb) {
        ...
        protected void zza(zzix com_google_android_gms_internal_zzix) throws RemoteException {
            com_google_android_gms_internal_zzix.zzb(new C07331(this), this.zzNZ);
        }
    ...
    final class zzc extends zza<Status> {
        ...
        class C07341 extends com.google.android.gms.internal.zziy.zza {
            final /* synthetic */ zzc zzOc;

            C07341(zzc com_google_android_gms_internal_zziw_zzc) {
        ...
        protected void zza(zzix com_google_android_gms_internal_zzix) throws RemoteException {
            com_google_android_gms_internal_zzix.zza(new C07341(this), this.zzNZ);
        }
