...
public class zznb implements HistoryApi {
    ...
    public PendingResult<DailyTotalResult> readDailyTotal(GoogleApiClient client, final DataType dataType) {
        return client.zza(new zza<DailyTotalResult>(this, client) {
            ...
            class C07701 extends com.google.android.gms.internal.zzme.zza {
                final /* synthetic */ C07714 zzall;

                C07701(C07714 c07714) {
                    this.zzall = c07714;
                }
            ...
            protected void zza(zzlz com_google_android_gms_internal_zzlz) throws RemoteException {
                ((zzmk) com_google_android_gms_internal_zzlz.zznM()).zza(new DailyTotalRequest(new C07701(this), dataType, com_google_android_gms_internal_zzlz.getContext().getPackageName()));
            }
        });
    }
