...
public final class GooglePlayServicesUtil {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0116R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (zzi == null) {
            zzi = resources.getString(C0116R.string.common_google_play_services_notification_ticker);
        }
        ...
        if (zzkz.zzai(context)) {
            zzu.zzU(zzlk.zzoV());
            build = new Notification.Builder(context).setSmallIcon(C0116R.drawable.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new BigTextStyle().bigText(zzi + " " + zzc)).addAction(C0116R.drawable.common_full_open_on_phone, resources.getString(C0116R.string.common_open_on_phone), errorPendingIntent).build();
        } else {
            CharSequence string = resources.getString(C0116R.string.common_google_play_services_notification_ticker);
            if (zzlk.zzoR()) {
                Notification build2;
