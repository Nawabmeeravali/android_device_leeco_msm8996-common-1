...
public class zzam {
    ...
    public static String zzH(boolean z) {
        return z ? "1" : Constants.THEME_LIGHT;
    }
    ...
    public static boolean zza(double d, String str) {
        return d > 0.0d && d < 100.0d && ((double) (zzbm(str) % StatusCodes.AUTH_DISABLED)) >= 100.0d * d;
    }
    ...
    public static void zzb(Map<String, String> map, String str, boolean z) {
        if (!map.containsKey(str)) {
            map.put(str, z ? "1" : Constants.THEME_LIGHT);
        }
    }
    ...
    public static boolean zze(String str, boolean z) {
        return str != null ? (str.equalsIgnoreCase("true") || str.equalsIgnoreCase("yes") || str.equalsIgnoreCase("1")) ? true : (str.equalsIgnoreCase("false") || str.equalsIgnoreCase("no") || str.equalsIgnoreCase(Constants.THEME_LIGHT)) ? false : z : z;
    }
}
