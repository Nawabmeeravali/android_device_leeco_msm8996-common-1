...
public class zzb extends zzd {
    ...
    class C01595 implements Runnable {
        ...
        C01595(zzb com_google_android_gms_analytics_internal_zzb) {
    ...
    class C01617 implements Callable<Void> {
        final /* synthetic */ zzb zzJs;

        C01617(zzb com_google_android_gms_analytics_internal_zzb) {
            this.zzJs = com_google_android_gms_analytics_internal_zzb;
        }
