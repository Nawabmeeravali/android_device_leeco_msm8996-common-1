...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C00963();
    boolean mFinishing;
    ...
    class C00963 implements Callback {
        C00963() {
        }
    ...
    private void setupAnimators() {
        ...
        animation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationRepeat(Animation animation) {
                ...
                MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + TextTrackStyle.DEFAULT_FONT_SCALE) % 5.0f;
            }
        });
