...
public final class RatingCompat implements Parcelable {
    public static final Creator<RatingCompat> CREATOR = new C00351();
    ...
    static class C00351 implements Creator<RatingCompat> {
        C00351() {
        }
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? TextTrackStyle.DEFAULT_FONT_SCALE : 0.0f);
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == TextTrackStyle.DEFAULT_FONT_SCALE) {
            return true;
        }
        return false;
    }
