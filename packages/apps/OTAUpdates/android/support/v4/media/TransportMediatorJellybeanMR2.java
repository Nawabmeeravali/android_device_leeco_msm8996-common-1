...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00414();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00403();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00381();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00392();

    class C00381 implements OnWindowAttachListener {
        C00381() {
        }
    ...
    class C00392 implements OnWindowFocusChangeListener {
        C00392() {
        }
    ...
    class C00414 implements OnAudioFocusChangeListener {
        C00414() {
        }
