...
public class TransportMediator extends TransportController {
    ...
    class C00361 implements TransportMediatorCallback {
        C00361() {
        }
    ...
    class C00372 implements Callback {
        C00372() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C00361();
        this.mKeyEventCallback = new C00372();
