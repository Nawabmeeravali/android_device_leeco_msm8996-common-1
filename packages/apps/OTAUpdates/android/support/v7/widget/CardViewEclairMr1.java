...
class CardViewEclairMr1 implements CardViewImpl {
    ...
    class C01141 implements RoundRectHelper {
        C01141() {
        }
        ...
        public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
            ...
            if (cornerRadius >= TextTrackStyle.DEFAULT_FONT_SCALE) {
                ...
                canvas.drawRect((bounds.left + cornerRadius) - TextTrackStyle.DEFAULT_FONT_SCALE, bounds.top, TextTrackStyle.DEFAULT_FONT_SCALE + (bounds.right - cornerRadius), bounds.top + cornerRadius, paint);
                canvas.drawRect((bounds.left + cornerRadius) - TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE + (bounds.bottom - cornerRadius), TextTrackStyle.DEFAULT_FONT_SCALE + (bounds.right - cornerRadius), bounds.bottom, paint);
            }
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C01141();
    }
